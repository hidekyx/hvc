    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title mb-3 pb-0">Create New Payment</h5>
                        <form action="{{ asset('/dashboard/payment-setting/store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                            ...
                            <div id="payment_normal" style="display: none;">
                                <div class="row mb-3">
                                    <label for="account_holder" class="col-lg-2 col-form-label">Account Holder</label>
                                    <div class="col-lg-10">
                                        <input name="account_holder" type="text" class="form-control" id="account_holder" required>
                                    </div>
                                </div>
                            ...
                            <div id="payment_qris" style="display: none;">
                                <div class="row mb-3">
